...
button.addEventListener('click', () => { 
    ...
    xhr.open('GET', 'https://api.hsbc.com.mx/x-open-banking/v1.0/atms/country/MX/town/Huixquilucan')
    ...
    xhr.addEventListener('load', (data) => {
        ...
        for(var f=0; f>=n; f++)
        {
            ...
            <br> Municipio: ${dataJSON.data['0'].Brand['0'].ATM[f].Location.PostalAddress.TownName}
